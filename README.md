# @ednaldocordeiro/react-native-background-geolocation

[![npm](https://img.shields.io/npm/v/@ednaldocordeiro/react-native-background-geolocation?style=flat-square)](https://www.npmjs.com/package/@ednaldocordeiro/react-native-background-geolocation)
...
```
yarn add @ednaldocordeiro/react-native-background-geolocation
```
...
```
node ./node_modules/@ednaldocordeiro/react-native-background-geolocation/scripts/postlink.js
```
...
include ':@ednaldocordeiro_react-native-background-geolocation'
project(':@ednaldocordeiro_react-native-background-geolocation').projectDir = new File(rootProject.projectDir, '../node_modules/@ednaldocordeiro/react-native-background-geolocation/android/lib')
...
```
...
dependencies {
    ...
    compile project(':@ednaldocordeiro_react-native-background-geolocation')
    ...
}
```
...
2. Add `./node_modules/@ednaldocordeiro/react-native-background-geolocation/ios/RCTBackgroundGeolocation.xcodeproj`
...
import BackgroundGeolocation from "@ednaldocordeiro/react-native-background-geolocation";
